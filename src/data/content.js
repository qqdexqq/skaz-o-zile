...
export const PROGRAM = [
  {
    ...
    text: "Встречаем добрых молодцев да красных девиц с почестями",
  },
  {
    time: "13:30 — 14:30",
    title: "Welcome-чарочка",
    text: "Разливаем напитки хмельные да заморские, заздравные речи заводим",
  },
  {
    time: "14:30 — 22:00",
...
export const DRESS_CODE = {
  ...
  text:
    "Просим поддержать атмосферу сказки и облачиться в наряды яркие, " +
